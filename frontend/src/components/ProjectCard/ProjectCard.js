...
export const ProjectCard = ({ title, description, imgUrl, likesCount }) => {
  return (
      <div className={s.projectCard}>
        {/*<img src={imgUrl} className={s.projectCardImage} alt=""/>*/}
        <img src={"https://www.ren-design.ru/api/portfolio-hub/1.0/files/projectPreviews/"+imgUrl} className={s.projectCardImage} alt=""/>
