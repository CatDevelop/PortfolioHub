...
import s from './CatalogUserCard.module.css';
...
export const CatalogUserCard = (props) => {
    const navigate = useNavigate();
    return (
        <div className={s.categoryUserCard} onClick={()=>navigate("/"+props.userID)}>
            <div className={s.leftContainer}>
                <img src={"https://www.ren-design.ru/api/portfolio-hub/1.0/files/avatars/"+props.avatar} alt="" className={s.avatar}/>
                <div className={s.userInfo}>
                    <div className={s.userNameAndDescription}>
