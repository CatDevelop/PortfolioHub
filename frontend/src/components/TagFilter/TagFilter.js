...
import s from './TagFilter.module.css';
...
function TagFilter(props) {
    ...
    return (
        <div className={s.selectContainer}>
            ...
            <Select
                options={props.filter === "language" ? languagesList : props.filter === "role" ? rolesOptions : levelOptions}
                placeholder={props.filter === "language" ? 'Язык программирования' : props.filter === "role" ? 'Роль в команде' : 'Уровень специализации'}
