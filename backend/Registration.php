<?php
	...
	$A3 = $Link->query("INSERT INTO Users (Login, Email, Password, Tags, PhotoSource, BannerSource) VALUES('$login', '$email', '$password', '[]', 'plumb.png', 'Plumb.png')"); 
	$UserID = $Link->insert_id;
	$UniqueLink = uniqid();
	$A4 = $Link->query("INSERT INTO ActivationLink (UserID, Link) VALUES('$UserID', '$UniqueLink')"); 

	$template = addslashes('{"time":1686938937520,"blocks":[{"id":"7WAQHwPGje","type":"header","data":{"text":"Привет! 🤚","level":1},"tunes":{"anyTuneName":{"alignment":"center"}}},{"id":"_QSg_7Rzs6","type":"header","data":{"text":"Это блочный редактор Portfolio Hub ✒️","level":2},"tunes":{"anyTuneName":{"alignment":"center"}}},{"id":"TdLo2o09MU","type":"paragraph","data":{"text":"Ты встретишься с ним при редактировании портфолио или информации о проекте. Давай познакомимся ближе, ниже будет представлен шаблон, который расскажет о всех возможностях, ты можешь с ним ознакомиться и удалить, выделив всё содержимое."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"center"}}},{"id":"g6tYUEgwSR","type":"delimiter","data":{}},{"id":"DPfatlhnac","type":"header","data":{"text":"Концепция №1. Всё есть \"блок\"","level":3},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"zPhf79_GIY","type":"paragraph","data":{"text":"Нужно представить, что каждый элемент содержимого, который вы добавляете на страницу - будь то текст, изображение или таблица - это один строительный блок. Любая страница - это стопка блоков. Их можно скомбинировать так, как вы захотите."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"1Cx71voZ_9","type":"paragraph","data":{"text":"Нужно нажать <code class=\"inline-code\">Tab</code> на клавиатуре (или нажмите кнопку + слева от редактора). Так вы увидите все типы разного контента, который можете добавить."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"rE9pXEbKjh","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"GFWSiArBk-","type":"header","data":{"text":"Концепция №2. Блоки могут трансформироваться","level":3},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"phIh-2GCGJ","type":"paragraph","data":{"text":"Любой блок информации можно превратить в другой тип блока или же видоизменить."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"e-HfRpi6y0","type":"paragraph","data":{"text":"Это можно сделать выбрав вот такой символ <code class=\"inline-code\">⋮⋮</code> слева от блока, он называется кнопкой блока. В зависимости от типа блока будут доступны разные настройки, подробнее о каждой из них будет написано в описании конкретного блока."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"09E9On96Ob","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"eLmD25xSKV","type":"header","data":{"text":"Концепция №3. Текст можно модифицировать","level":3},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"risaL4rx6B","type":"paragraph","data":{"text":"При выделении текста в любом блоке, будь то таблица или же цитата, вы можете изменять его оформление. Делать <b>жирным</b>, <i>курсивным</i>, <u class=\"cdx-underline\">подчёркнутым</u>, <s class=\"cdx-strikethrough\">зачёркнутым</s>, <mark class=\"cdx-marker\">выделенным</mark>, <code class=\"inline-code\">внутренним кодом </code>, <a href=\"https://vk.com\">ссылкой</a>, <b><i>или же </i></b><u class=\"cdx-underline\"><s class=\"cdx-strikethrough\"><b><i></i></b>комбинировать все </s></u><code class=\"inline-code\"><b><u class=\"cdx-underline\"><s class=\"cdx-strikethrough\"></s></u>стили</b></code>."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"671S1Zz3qy","type":"delimiter","data":{}},{"id":"OR_x5FhZtN","type":"header","data":{"text":"Описание блоков","level":2},"tunes":{"anyTuneName":{"alignment":"center"}}},{"id":"1H0UDTql4q","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Текстовый блок</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"1hSbyGDWzx","type":"paragraph","data":{"text":"Это текстовый блок. Вы можете ввести в него столько текста, сколько захотите. Как только вы нажмете <code class=\"inline-code\">Enter</code>, вы создадите разрыв строки и перейдите к новому блоку. С помощью меню блока можно изменить центрирование текста."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"fMzn2WnMze","type":"paragraph","data":{"text":"Совет: Вы можете нажать <code class=\"inline-code\">Shift + Enter</code>, чтобы создать разрывы строк внутри одного текстового блока.<br>Обратите внимание, как я это сделал, чтобы создать эту новую строку внутри того же блока, что и текст выше."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"2JoXYR0ju5","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"cv5KySpv84","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Нумерованный и ненумерованный списки</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"gh2HlW4wAH","type":"list","data":{"style":"ordered","items":[{"content":"Я перечисляю пронумерованные вещи","items":[]},{"content":"Могу иметь несколько пунктов","items":[{"content":"И несколько уровней","items":[{"content":"Чтобы сделать вложенный пункт, необходимо нажать <code class=\"inline-code\">Tab</code>","items":[]}]}]}]}},{"id":"4FB-pK-4U5","type":"list","data":{"style":"unordered","items":[{"content":"Порядок меня волнует гораздо меньше.","items":[{"content":"Но я тоже могу иметь несколько уровней","items":[{"content":"Чтобы выйти из редактирования списка, необходимо несколько раз нажать <code class=\"inline-code\">Enter</code>","items":[]}]}]}]}},{"id":"1QzidF-Cr4","type":"paragraph","data":{"text":""},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"5VqDXZSObk","type":"paragraph","data":{"text":"<u>Цитата</u>"},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"lUo-W8sjzr","type":"quote","data":{"text":"Не волнуйтесь, если что-то не работает. Если бы всё работало, вас бы уволили.","caption":"Mosher’s Law of Software Engineering","alignment":"left"}},{"id":"3flrbET2Jn","type":"quote","data":{"text":"Иногда лучше остаться спать дома в понедельник, чем провести всю неделю в отладке написанного в понедельник кода.","caption":"Christopher Thompson","alignment":"center"}},{"id":"mdXrFcMjSH","type":"paragraph","data":{"text":""},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"qObOcnUkA0","type":"paragraph","data":{"text":"<u>Кнопка с ссылкой<br></u>"},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"MzxuYh60Ar","type":"AnyButton","data":{"link":"https://vk.com/cat_dev","text":"Страница разработчика во Вконтакте"}},{"id":"VI4b2y2h4n","type":"paragraph","data":{"text":""},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"Jfv8pgW4Mo","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Чек лист</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"DYBvCVW7px","type":"checklist","data":{"items":[{"text":"Выполненный элемент","checked":true},{"text":"Невыполненный элемент","checked":false}]}},{"id":"pDTjAchG8_","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"e5DoaRMS7_","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Заголовки</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"Gd_x7Ym-tZ","type":"header","data":{"text":"Заголовок 1 уровня","level":1},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"5PFY2aPKiY","type":"header","data":{"text":"Заголовок 2 уровня","level":2},"tunes":{"anyTuneName":{"alignment":"center"}}},{"id":"P-6nHuB7wy","type":"header","data":{"text":"Заголовок 3 уровня","level":3},"tunes":{"anyTuneName":{"alignment":"right"}}},{"id":"PKlWUVrOnw","type":"header","data":{"text":"Заголовок 4 уровня","level":4},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"aPFB40maW7","type":"header","data":{"text":"Заголовок 5 уровня","level":5},"tunes":{"anyTuneName":{"alignment":"center"}}},{"id":"JPpurdBQRm","type":"header","data":{"text":"Заголовок 6 уровня","level":6},"tunes":{"anyTuneName":{"alignment":"right"}}},{"id":"KF250ZeM8r","type":"paragraph","data":{"text":"Как вы могли заметить, заголовки и текст могут быть центрированы 3 способами: слева, посередине и справа."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"T0CfQD7hn3","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"bDs-8qw4G9","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Разделитель</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"kl6CueNSSv","type":"delimiter","data":{}},{"id":"x0E_Fu26xk","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"JFuhO6vInU","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Таблица</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"SBCuf8a5PO","type":"table","data":{"withHeadings":false,"content":[["1 столбец 1 строка","\n2 столбец 1 строка"],["\n1 столбец 2 строка","\n2 столбец 2 строка"]]}},{"id":"dpDo4_F0p5","type":"paragraph","data":{"text":"В настройках блока можно включить выделение верхней строки, в режиме редактирования она будет выделена жирным, а в режиме просмотра - иметь особое оформление."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"cHRazjRq2h","type":"table","data":{"withHeadings":true,"content":[["Game","Platform","Type","Notes"],["Dance Dance Revolution","Arcade","Rhythm","I may or may not have spent $2400 on metal dance pads for my house..."],["Celeste","Switch","Platformer","<mark>I still haven\'t beaten the C Sides.</mark>"],["Hollow Knight","Switch","Metroidvania","Path of Pain is my favorite part 💗"],["Overwatch","PC","First Person Shooter","Main: <mark>Pharah!</mark>"],["Hades","Switch","Roguelike","Max-crit % bow builds for life 🏹"],["Portal 2","PC","Puzzle","Caroline."],["Assassin\'s Creed Revelations","Xbox 360","Action RPG","<code>I just love the linear sections so much.</code>"],["Slay the Spire","PC","Roguelike Deckbuilder","I literally always play <a href=\"https://www.youtube.com/watch?v=Fc-9zqtoFa0\">The Silent</a>"],["The Legend of Zelda: Breath of the Wild","Switch","Action RPG","Note to self: <a href=\"https://www.notion.so/Replay-Breath-of-the-Wild-f6e4ff51404b41dea9a45ad0a9748d4c\">🩳Replay Breath of the Wild</a> "],["Enter the Gungeon","Switch","Roguelike","Pew pew"]]}},{"id":"k0KBmNOVgi","type":"paragraph","data":{"text":""},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"Otij-1ajrM","type":"paragraph","data":{"text":"<u class=\"cdx-underline\">Код</u>"},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"Tj81fbvP4n","type":"code","data":{"code":"function *calculator(input) {\n    var doubleThat = 2 * (yield (input / 2))\n    var another = yield (doubleThat)\n    return (input * doubleThat * another)\n}\n\n// инициализация со значением 10\nconst calc = calculator(10)\n\n// запуск калькулятора\ncalc.next() "}},{"id":"vy6OZ2hjbB","type":"paragraph","data":{"text":"На данный момент поддерживается только подсветка JavaScript языка, но в будущем будут добавлены и другие языки программирования."},"tunes":{"textVariant":"","anyTuneName":{"alignment":"left"}}},{"id":"2jPoMZNwoa","type":"paragraph","data":{"text":""},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"U36ugAym9z","type":"paragraph","data":{"text":"<u>Изображение по ссылке<br></u>"},"tunes":{"anyTuneName":{"alignment":"left"}}},{"id":"oRi32U3WUN","type":"inlineImage","data":{"url":"https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?crop=entropy&amp;cs=srgb&amp;fm=jpg&amp;ixid=M3w0MzQyNDJ8MHwxfHNlYXJjaHwxfHxDYXR8ZW58MHx8fHwxNjg2OTI4MTc5fDA&amp;ixlib=rb-4.0.3&amp;q=85","caption":"Милый котик с Unsplach<br>","withBorder":false,"withBackground":false,"stretched":false,"unsplash":{"author":"Manja Vitolic","profileLink":"https://unsplash.com/@madhatterzone"}}},{"id":"GP-PGCK1K-","type":"inlineImage","data":{"url":"https://kot-pes.com/wp-content/uploads/2015/06/Sanshu-Dog1.jpg","caption":"Собачка из интернета (в рамке)<br>","withBorder":true,"withBackground":false,"stretched":false}}],"version":"2.26.5"}');
